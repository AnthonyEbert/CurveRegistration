...
The posterior distributions are shown in Figure. The registered distances performs better than the unregistered ones. Interestingly the distance used for registration, FR, performs less well than MMD. What is surprising is that the Registered MMD performs better than the Elastic distance.
