...
Explanations: 
* In the previous examples there was a high dimensional latent variable controlling peak shift location, in this example the lag is controlled by one variable. 
* 
...
* We considered problems with high dimensional nuisance variables which we preferred to not to estimate directly
* Registered dissimilarity is useful but registration can also be used to "correct" input data. 
* 
