...
vline_df = data.frame(parameter = c("sigma[phi]", "sigma[epsilon]","eta"), input = true_params, value = c(1, 1, 1))

blank_df <- data.frame(parameter = c("sigma[phi]", "sigma[epsilon]","eta", "eta"), value = c(3,0.005,1,-1))
...
output_tidy$parameter <- factor(output_tidy$parameter, levels = c("sigma[phi]", "eta", "sigma[epsilon]"))
